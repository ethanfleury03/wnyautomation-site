const homepageFaqs = [
  ...
  },
  {
    ...
    answer:
      "No. The goal is to reduce repetitive admin work so your team can respond faster and spend more time on higher-value tasks.",
  },
  {
...
const workflowAuditFaqs = [
  ...
  },
  {
    ...
    answer:
      "No formal prep is needed. A short description of the manual task, the tools involved, and where the handoff breaks down is enough to start.",
  },
  {
    question: "Will you recommend automation even if it is not worth it?",
    answer:
      "No. Some workflows need a simpler process change before automation. The audit is meant to find the highest-value first step.",
  },
  {
    question: "Can the first automation be small?",
    answer:
      "Yes. The recommended approach is to start small, prove value, and improve from there.",
  },
];
